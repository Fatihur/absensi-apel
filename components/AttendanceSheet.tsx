...
export default function AttendanceSheet({ month, year }: AttendanceSheetProps) {
  ...
  return (
    <div className="bg-white p-8 shadow-lg print:shadow-none print:p-0 w-[330mm] mx-auto min-h-[215mm] font-sans text-[10px] text-black">
      <table className="w-full border-none">
        ...
        <thead className="table-header-group">
          <tr>
            <td>
              {/* Header Content */}
              <div className="flex items-center justify-center mb-6 relative border-b-2 border-black pb-4">
                ...
                <div className="text-center">
                  <h1 className="text-sm font-bold leading-tight">KEMENTERIAN IMIGRASI DAN PEMASYARAKATAN REPUBLIK INDONESIA</h1>
                  <h2 className="text-sm font-bold leading-tight">DIREKTORAT JENDERAL PEMASYARAKATAN</h2>
                  <h2 className="text-sm font-bold leading-tight">KANTOR WILAYAH NUSA TENGGARA BARAT</h2>
                  <h2 className="text-base font-bold leading-tight">BALAI PEMASYARAKATAN KELAS II SUMBAWA BESAR</h2>
              ...
              <div className="text-center mb-6">
                <h3 className="text-sm font-bold underline">ABSENSI APEL STAF BULAN {monthName}</h3>
                <h3 className="text-sm font-bold">BALAI PEMASYARAKATAN KELAS II SUMBAWA BESAR</h3>
              </div>
            </td>
          </tr>
        </thead>
            ...
            <td>
              <div className="print:overflow-visible">
                <table className="w-full border-collapse border border-black">
                  <thead>
                    <tr>
                      <th className="border border-black px-1 py-2 w-8 bg-blue-100" rowSpan={2}>NO</th>
                      <th className="border border-black px-2 py-2 w-64 bg-blue-100" rowSpan={2}>NAMA</th>
                      {workingDays.map((day, idx) => (
                        <th key={idx} className="border border-black text-center text-[8px] bg-blue-100 h-6 min-w-[25px]">
                  ...
                  <tbody>
                    {STAFF_LIST.map((name, idx) => (
                      <tr key={idx} className="h-6">
                        ...
                        <td className="border border-black px-2 font-bold uppercase">{name}</td>
              ...
              <div className="mt-8 flex justify-between items-start px-4">
                ...
                <div className="text-center w-64">
                  <p className="mb-16">Kepala,</p>
                  <p className="font-bold underline">{HEAD_OF_OFFICE.name}</p>
