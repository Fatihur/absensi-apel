          ...
          <tr>
            <td>
              ...
              <div className="flex items-center justify-center mb-6 relative border-b-2 border-black pb-4 mx-2">
                ...
                <div className="text-center px-16">
                  ...
                  <h2 className="text-[14px] font-bold leading-tight">
                    BALAI PEMASYARAKATAN KELAS II SUMBAWA BESAR
                  </h2>
                  <p className="text-[9px]">
                    Jalan Raya Jurusan Bima Km-07, Sumbawa Besar-NTB 84316
                    Telepon (0371)-2629132
                  </p>
                  <p className="text-[9px]">
                    Laman: https://bapassumbawa.com Surel:
                    bapassumbawa@gmail.com
                  </p>
                </div>
              </div>
              ...
              <div className="text-center mb-4">
                <h3 className="text-[12px] font-bold underline">
                  ABSENSI APEL STAF BULAN {monthName}
                </h3>
              ...
              <div className="print:overflow-visible px-2">
                <table className="w-full border-collapse border border-black table-fixed">
                  <thead>
                    <tr>
                      <th
                        className="border border-black px-1 py-1 w-[30px] bg-blue-100"
                        rowSpan={2}
                      >
                        NO
                      </th>
                      <th
                        className="border border-black px-2 py-1 w-[180px] bg-blue-100"
                        rowSpan={2}
                      >
                        NAMA
                      </th>
                      {workingDays.map((day, idx) => (
                        <th
                          key={idx}
                          className="border border-black text-center text-[8px] bg-blue-100 h-6"
                        >
                  ...
                  <tbody>
                    {STAFF_LIST.map((name, idx) => (
                      <tr key={idx} className="h-6">
                        ...
                        <td className="border border-black px-2 font-bold uppercase text-[9px] truncate">
                          {name}
                        </td>
